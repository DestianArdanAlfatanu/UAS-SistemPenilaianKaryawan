                ...
                <div class="py-12">
                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            ...
                            <a href="{{ route('viewtambahkaryawan') }}"><button class="btn btn-warning">Tambah
                                    Karyawan</button></a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('viewnilaikaryawan', ['id' => $k->id]) }}"><button
                                                        class="btn btn-default">Kasih Nilai</button></a>
                                                <a href="{{ route('karyawanedit', ['id' => $k->id]) }}"><button
                                                        class="btn btn-default">Edit Profil</button></a>
